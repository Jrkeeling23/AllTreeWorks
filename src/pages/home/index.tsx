    ...
    return (
        ...
        >
            <Box display="flex" flexDirection={"column"} gap="1rem" >
                ...
                <Typography>
                    With experience and a commitment to safety, we treat every property
                    as if it were our own. Whether it's trimming to improve tree health
                    or removing a hazardous limb, our certified team is here to handle
                    it with care, precision, and respect for your space. Fully insured,
            ...
            <Box display="flex" flexDirection={"column"} gap="1rem" >
                ...
                <Box display="flex" flexDirection={"column"} gap="2rem" alignItems={"flex-end"} >
